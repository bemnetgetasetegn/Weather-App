...
const NavBar = () => {
  ...
  return (
    <div className="flex w-full border-[1px] border-white/20 my-10 p-3 md:py-3 transform transition-transform hover:scale-105 justify-around items-center rounded-2xl">
